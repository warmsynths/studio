...
/**
 * Placeholder for the real j6-companion Lit component.
 * Replace this file's contents with the real embed — keep the
 * `j6-companion-embed` tag name so tape-app-slot.ts picks it up unchanged.
 */
...
export class J6CompanionEmbed extends LitElement {
  ...
  render() {
    return html`EMBED PENDING — J-6 COMPANION`;
  }
}
