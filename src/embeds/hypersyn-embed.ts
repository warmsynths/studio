...
/**
 * Placeholder for the real hypersyn-chord-helper Lit component.
 * Replace this file's contents with the real embed — keep the
 * `hypersyn-embed` tag name so tape-app-slot.ts picks it up unchanged.
 */
...
export class HypersynEmbed extends LitElement {
  ...
  render() {
    return html`EMBED PENDING — HYPERSYN HELPER`;
  }
}
